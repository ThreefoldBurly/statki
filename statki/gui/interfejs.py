...
class Interfejs(ttk.Frame):
    ...
    def buduj_plansze(self, gracz, przeciwnik):
        """Buduj plansze gracza i przeciwnika"""
    ...
    def buduj_sekcje_kontroli(self):
        """Buduj sekcje kontroli: ataku, floty i gry po prawej stronie okna głównego."""
    ...
    def buduj_pasek_komunikatow(self):
        """Buduj pasek komunikatów na dole okna głównego"""
    ...
    def ustaw_grid(self):
        """
        Konfiguruj layout managera. Dopuszcza powiększanie trzeciej kolumny (w poziomie) i czwartego rzędu (w pionie). Zmień ustawienia dwóch ostatnich rzędów w zależności od wielkości planszy.
        """
    ...
    def przekaz_odnosniki(self):
        """Przekaż odnośniki pomiędzy sekcjami."""
        # PG
    ...
    def wybierz_statek_startowy(self):
        """Wybierz największy statek na rozpoczęcie gry."""
    ...
    def przekaz_komunikator(self):
        """Twórz, ustaw i przekaż widżetom komunikator."""
    ...
    def wyswietl_komunikaty(self):
        """Wyświetl komunikaty w polu tekstowym paska komunikatów."""
